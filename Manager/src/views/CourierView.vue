<template>
    <div id="CourierPage">
        ...
        <el-breadcrumb separator="/" style="font-size:20px;">
            ...
            <el-breadcrumb-item>快递员列表</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="page-content">
            <div style="display:flex;">
                ...
                <!-- 添加按钮 -->
                <el-button type="primary" style="margin:10px;" @click="addCourier()">添加</el-button>
            </div>
        ...
        <el-dialog title="添加快递员" v-model="dialogFormVisible">
        ...
        <el-dialog title="修改快递员信息" v-model="dialogFormChangeVisible">
    ...
    export default{
        ...
        methods:{
            getSocketData(res){
                ...
                }else if(res.detail.data.includes("NOTFUND_COURIER")){
                    //未查找到快递员
            ...
            handleDelete(index,row){
                this.socketServe.send("courierDelete:"+row.id);
            },
            addCourier(){
                this.formData.id="";
            ...
            addConfirm(){
                this.socketServe.send("courierFindId:"+this.formData.id+":"+this.formData.password+":"+this.formData.nickname+":"+this.formData.phone);
            },
            changeConfirm(){
                this.socketServe.send("courierChange:"+this.oldId+":"+this.formDataChange.id+":"+this.formDataChange.password+":"+this.formDataChange.nickname+":"+this.formDataChange.phone);
            },
            searchByKeyword(){
                this.list=[];
                this.socketServe.send("SearchCourier:"+this.keyword);
